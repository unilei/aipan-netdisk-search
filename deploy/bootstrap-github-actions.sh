...
REDEMPTION_CODE_HASH_SECRET="$(remote_env REDEMPTION_CODE_HASH_SECRET || true)"
...
TVBOX_SYNC_TIME="$(remote_env TVBOX_SYNC_TIME || true)"
TVBOX_SYNC_ENABLED="$(remote_env TVBOX_SYNC_ENABLED || true)"
...
TVBOX_SYNC_TIME="${TVBOX_SYNC_TIME:-03:20}"
TVBOX_SYNC_ENABLED="${TVBOX_SYNC_ENABLED:-true}"
...
set_secret_from_value "REDEMPTION_CODE_HASH_SECRET" "${REDEMPTION_CODE_HASH_SECRET}"
...
set_secret_from_value "TVBOX_SYNC_TIME" "${TVBOX_SYNC_TIME}"
set_secret_from_value "TVBOX_SYNC_ENABLED" "${TVBOX_SYNC_ENABLED}"

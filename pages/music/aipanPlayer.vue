...
const drawDefaultTheme = (ctx, width, height, dataArray, hue) => {
...
const drawSpectrumTheme = (ctx, width, height, dataArray, hue) => {
...
const drawParticlesTheme = (ctx, width, height, dataArray, hue) => {
  const particles = 50;
  const radius = 2;
  let prevY = height / 2;
...
const drawMinimalTheme = (ctx, width, height, dataArray) => {
...
const drawCircularVisualizer = (hue) => {

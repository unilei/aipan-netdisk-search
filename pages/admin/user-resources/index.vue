            ...
            <div v-if="selectedResource" class="space-y-4">
                ...
                <div>
                    ...
                    <p class="text-gray-900 mt-1">
                        <el-link type="primary" :href="selectedResource.links" target="_blank">
                ...
                <div>
                    ...
                    <p class="text-gray-900 mt-1">{{ selectedResource.creator.username }}</p>
                </div>
                <div>
                    <label class="text-gray-500">上传时间</label>
                    <p class="text-gray-900 mt-1">{{ formatDate(selectedResource.createdAt) }}</p>
                </div>
                <div>
...
const fetchResources = async () => {
    ...
    try {
        ...
        const response = await $fetch(`/api/admin/user-resources/get?${params.toString()}`, {
            method: 'GET',
            headers: {

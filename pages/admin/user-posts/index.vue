    ...
    <div class="mx-auto space-y-6">
      ...
      <div class="admin-card-bg rounded-lg p-6 shadow-sm">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">用户文章管理</h1>
            <p class="text-gray-500 dark:text-gray-400 mt-1">管理用户投稿的文章内容</p>
          </div>
...
const fetchPosts = async () => {
  ...
  try {
    ...
    const response = await $fetch(
      `/api/admin/user-posts/get?${params.toString()}`,
      {
        method: "GET",
        headers: {

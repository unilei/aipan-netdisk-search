...
<template>
  ...
  >
    <div
      class="max-w-[1240px] mx-auto px-4 py-8 sm:px-6 lg:px-8 animate-fadeIn"
    >
      <!-- 头部区域 -->
      <div class="text-center mb-12">
        ...
        >
          ...
          <span
            v-if="cacheInfo && cacheInfo.exists"
      ...
      <div class="max-w-3xl mx-auto mb-10 space-y-6">
        <div class="relative group w-full md:w-[700px] mx-auto">
          ...
          <span class="absolute right-5 top-1/2 -translate-y-1/2 text-gray-400">
            <i
              class="fas fa-search transition-transform duration-300 group-hover:scale-110"
            ></i>
          </span>
        </div>
      </div>
      ...
      <div v-if="isLoading" class="flex items-center justify-center py-16">
        <div class="text-center">
          <div class="relative w-16 h-16 mx-auto mb-4">
            <div
              class="absolute inset-0 border-4 border-blue-500/30 dark:border-blue-700/30 rounded-full"
            ></div>
            <div
      ...
      <div v-else class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div
          v-for="(item, index) in filteredTvbox"
          :key="index"

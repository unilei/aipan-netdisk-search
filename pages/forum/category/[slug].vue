      ...
      <div v-if="loading" class="flex flex-col space-y-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-3 mb-4">
          <div class="flex items-start">
            <div
              class="w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded-lg mr-3 flex-shrink-0"
            ></div>
            <div class="flex-1">
              <div
                class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-1/3 mb-2"
              ></div>
              <div
                class="h-3 bg-gray-200 dark:bg-gray-700 rounded w-2/3 mb-2"
              ></div>
              <div
                class="h-3 bg-gray-200 dark:bg-gray-700 rounded w-1/4 mt-2"
              ></div>
            </div>
        ...
        >
          ...
          >
            ...
            <div
              class="w-24 hidden md:block ml-2 h-4 bg-gray-200 dark:bg-gray-700 rounded"
            ></div>
            <div
              class="w-24 hidden md:block ml-2 h-4 bg-gray-200 dark:bg-gray-700 rounded"
            ></div>
            <div
              class="w-36 hidden md:block ml-2 h-4 bg-gray-200 dark:bg-gray-700 rounded"
            ></div>
          </div>
            ...
            <div class="flex">
              <div class="flex-1 pr-3">
                ...
                <div class="flex items-center">
                  <div
                    class="w-4 h-4 bg-gray-200 dark:bg-gray-700 rounded-full mr-2"
                  ></div>
                  <div
                  ...
                  <div class="flex">
                    <div class="flex-1 min-w-0 pr-3">
                      <div class="flex items-center mb-1">
                        ...
                        >
                          <i class="fas fa-thumbtack mr-0.5 text-[10px]"></i
                          >置顶
                        </span>
                        <span
                          v-if="topic.isLocked"
                    ...
                    <div
                      class="w-24 text-center backdrop: flex-col justify-center items-center hidden md:flex"
                    >
                      <span
                    ...
                    <div
                      class="w-24 text-center flex-col justify-center items-center hidden md:flex"
                    >
                      <span
                    ...
                    <div
                      v-if="topic.lastActivityAt"
                      class="w-36 text-center hidden md:block"
                    >

        ...
        <div
            ...
            <div class="max-w-6xl mx-auto px-4">
                <div class="py-3 flex items-center text-xs">
                    ...
                    <span class="text-gray-900 dark:text-white">{{ category?.name || '加载中...' }}</span>
                </div>
            </div>
        </div>
            ...
            <div v-else>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex items-start">
                            <div
                                ...
                                <i
                                    :class="[category?.icon || 'fas fa-folder', 'text-purple-600 dark:text-purple-400 text-xs']"></i>
                            </div>
                            <div>
                                <h1 class="text-sm font-medium text-gray-900 dark:text-white mb-1">{{ category?.name }}
                                </h1>
                                <p class="text-gray-600 dark:text-gray-300 text-xs">{{ category?.description }}</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden mb-4">
                    <div v-if="!topics || topics.length === 0" class="p-8 text-center">
                        ...
                        <h3 class="text-base font-medium text-gray-700 dark:text-gray-300 mb-2">暂无主题</h3>
                                ...
                                <NuxtLink :to="`/forum/topic/${topic.slug}`" class="block py-3 px-4">
                                    <div class="flex">
                                        <div class="flex-1 min-w-0 pr-3">
                                            ...
                                            <div class="flex items-center text-xs text-gray-500 dark:text-gray-400">
                                                <div class="flex items-center mr-3">
                                                    ...
                                                    <span class="text-xs">{{ topic.author.username }}</span>
                                                </div>
                                        ...
                                        <div v-else class="w-36 text-center hidden md:block">
                                            <div class="text-xs text-gray-400 dark:text-gray-500">暂无回复</div>
                                        </div>
                                    </div>
                                </NuxtLink>
                            </li>
                ...
                <div v-if="pagination && pagination.totalPages > 1" class="flex justify-center mt-6">
                    <el-pagination background layout="prev, pager, next" :total="pagination.total"
                        ...
                        @current-change="handlePageChange" class="!bg-transparent !text-sm" />
                </div>
            </div>
        </div>
    </div>

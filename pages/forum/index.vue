  ...
  <div class="bg-gray-50 dark:bg-gray-900 min-h-screen pb-12">
    ...
    <div class="max-w-6xl mx-auto p-4">
      ...
      >
        <!-- 分类骨架屏 -->
        <h2
          class="text-sm font-bold mb-4 text-left text-gray-800 dark:text-white flex items-center"
        >
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6">
          ...
          >
            <div class="p-3 flex items-start flex-1">
              <div
                class="w-7 h-7 bg-gray-200 dark:bg-gray-700 rounded-lg mr-3"
              ></div>
              <div class="flex-1">
                <div
                ...
                ></div>
                <div
                  class="h-2 bg-gray-200 dark:bg-gray-700 rounded w-full mb-2"
                ></div>
                <div
                  class="h-2 bg-gray-200 dark:bg-gray-700 rounded w-1/4"
                ></div>
              </div>
            </div>
            <div class="px-3 py-2 bg-gray-50 dark:bg-gray-750">
              <div
                class="h-3 bg-gray-200 dark:bg-gray-700 rounded w-16 mx-auto"
              ></div>
            </div>
          </div>
        </div>
        ...
        <div
          class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden mb-4"
        >
          <!-- 主题列表表头骨架 -->
          <div
          ...
          >
            ...
            <div
              class="w-24 hidden md:block ml-2 h-3 bg-gray-200 dark:bg-gray-700 rounded"
            ></div>
            <div
              class="w-24 hidden md:block ml-2 h-3 bg-gray-200 dark:bg-gray-700 rounded"
            ></div>
            <div
              class="w-36 hidden md:block ml-2 h-3 bg-gray-200 dark:bg-gray-700 rounded"
            ></div>
          </div>
              ...
              <div class="flex">
                <div class="flex-1 pr-3">
                  ...
                  <div class="flex items-center mb-1">
                    <div
                      class="h-3 bg-gray-200 dark:bg-gray-700 rounded-md w-12 mr-2"
                    ></div>
                    <div class="flex items-center">
                      <div
                        class="w-4 h-4 bg-gray-200 dark:bg-gray-700 rounded-full mr-1"
                      ></div>
                      <div
                        class="h-3 bg-gray-200 dark:bg-gray-700 rounded w-16 mr-3"
                      ></div>
                    </div>
                    <div class="flex items-center">
                      <div
                        class="w-3 h-3 bg-gray-200 dark:bg-gray-700 rounded-full mr-1"
                      ></div>
                      <div
                        class="h-3 bg-gray-200 dark:bg-gray-700 rounded w-12"
                      ></div>
                    </div>
                  </div>
                </div>
                ...
                <div class="w-24 text-center hidden md:block">
                  <div
                    class="h-4 bg-gray-200 dark:bg-gray-700 rounded mx-auto w-8 mb-1"
                  ></div>
                  <div
                    class="h-3 bg-gray-200 dark:bg-gray-700 rounded mx-auto w-12"
                  ></div>
                </div>
                ...
                <div class="w-36 text-center hidden md:block">
                  <div
                    class="h-3 bg-gray-200 dark:bg-gray-700 rounded mx-auto w-20"
                  ></div>
                </div>
              </div>
            </div>
      ...
      <div v-else>
        <!-- 论坛分类区域 -->
        <h2
          class="text-sm font-bold mb-4 text-gray-800 dark:text-white flex items-center"
        >
          <i
            class="fas fa-layer-group mr-2 text-purple-600 dark:text-purple-400"
          ></i>
          论坛分类
        </h2>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6">
          ...
          >
            <div class="p-3 flex items-start flex-1">
              ...
              <div class="flex-1">
                <h3
                  class="text-xs font-semibold mb-1 text-gray-800 dark:text-white"
                >
                  {{ category.name }}
                </h3>
                <p
            ...
            <div
              class="px-3 py-2 bg-gray-50 dark:bg-gray-750 border-t border-gray-100 dark:border-gray-700"
            >
              <button
              ...
              >
                <div class="py-3 px-4">
                  <div class="flex">
                    <div class="flex-1 pr-3">
                      ...
                      <div class="mb-2 flex items-center">
                        ...
                        >
                          <span
                            v-if="topic.isSticky"
                            class="bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-100 text-xs rounded px-1 mr-1.5 align-text-top inline-block"
                            >置顶</span
                          >
                          {{ topic.title }}
                        </NuxtLink>
                      ...
                      <!-- 元信息 -->
                      <div
                        class="flex items-center text-xs text-gray-500 dark:text-gray-400 flex-wrap"
                      >
                        <span
                        ...
                        <div class="flex items-center mr-3">
                          <div
                            class="w-4 h-4 rounded-full overflow-hidden bg-gray-200 dark:bg-gray-700 mr-1"
                          >
                            <img
                              :src="getAvatarUrl(topic.author)"
                    ...
                    <!-- 最后回复时间 -->
                    <div
                      class="w-36 text-center hidden md:block text-xs text-gray-500 dark:text-gray-400"
                    >

<template>
  <div>
    <div
      class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 flex"
    >
      <!-- 左侧聊天列表 -->
      <div
          ...
          <div v-if="todayChats.length > 0" class="space-y-1">
            ...
            >
              <div class="flex items-center space-x-3">
                <i
                  class="fas fa-message text-gray-400 dark:text-gray-500 text-sm"
                ></i>
                <div
          ...
          <div class="h-full flex flex-col">
            ...
            >
              <div class="flex items-center space-x-4">
                ...
                <span
                  class="text-base md:text-lg font-semibold bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent"
                  >AI 爱盼网盘小助手</span
                >
                </a>
              </div>
            ...
            <!-- 聊天历史区域 -->
            <div
              class="flex-1 overflow-y-auto px-3 md:px-6 py-4 md:py-6 space-y-4 md:space-y-6"
              id="chat-container"
            >
              <template v-for="(msg, index) in messages" :key="index">
                ...
                <div
                  v-if="msg.type === 'ai'"
                  class="flex items-start space-x-2 md:space-x-4 w-full md:max-w-4xl"
                >
                  <div
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    >
                      ...
                      <p
                        v-else
                        class="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed break-words"
                      >
                        {{ msg.content }}
                      </p>
                ...
                <div
                  v-else
                  class="flex items-start space-x-2 md:space-x-4 justify-end w-full md:max-w-4xl ml-auto"
                >
                  <div class="flex-1 min-w-0">
                    <div
                    ...
                    >
                      <p
                        class="text-white text-xs md:text-sm leading-relaxed break-words"
                      >
                        {{ msg.content }}
                      </p>
                    </div>
                  ...
                  >
                    <i
                      class="fas fa-user text-gray-600 dark:text-gray-300 text-xs md:text-sm"
                    ></i>
                  </div>
                </div>
              </template>
            ...
            >
              <div class="max-w-5xl mx-auto">
                <div class="relative">
                  ...
                  />
                  <div
                    class="absolute bottom-2 md:bottom-3 right-2 md:right-3 flex items-center space-x-2"
                  >
                    <el-button
                      type="primary"
                      :icon="Search"

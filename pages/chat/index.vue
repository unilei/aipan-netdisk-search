<template>
  <div class="flex flex-col h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <!-- 主聊天区域 -->
    <div
      class="flex-1 container mx-auto flex flex-col md:flex-row gap-4 p-4 overflow-hidden"
    >
      <!-- 左侧聊天室列表面板 -->
      <div
        class="md:w-80 w-full flex flex-col bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden shrink-0"
      >
        <!-- 搜索框 -->
        <div class="p-4 border-b dark:border-gray-700">
          <div class="relative">
            ...
            />
            <i
              class="i-carbon-search absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-gray-400"
            ></i>
          </div>
        </div>
        ...
        <div class="flex-1 overflow-y-auto" style="scrollbar-width: thin">
          ...
          >
            <i
              class="i-carbon-circle-dash animate-spin text-3xl mb-2 text-indigo-500"
            ></i>
            <p>加载中...</p>
          </div>
      ...
      <!-- 右侧聊天内容区域 -->
      <div
        class="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden flex flex-col"
      >
        <div
          v-if="!selectedRoomId"
          class="flex-1 flex flex-col items-center justify-center text-gray-500 p-6"
        >
          <div
            class="bg-gray-50 dark:bg-gray-750 p-8 rounded-xl text-center max-w-md"
          >
            <i
              class="i-carbon-messaging text-6xl mb-4 text-indigo-500 opacity-70"
            ></i>
            <h2
              class="text-2xl font-bold text-gray-700 dark:text-gray-200 mb-2"
            >
              开始聊天吧
            </h2>

  ...
  <div class="min-h-[calc(100vh-60px)] bg-gray-50 dark:bg-gray-900">
    <client-only>
      <div class="max-w-[1240px] mx-auto p-6">
        ...
        >
          <div
            class="relative h-32 bg-gradient-to-r from-blue-500 to-purple-500"
          >
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p
                  class="text-2xl font-bold text-gray-900 dark:text-gray-200 mt-1"
                >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          ...
          >
            ...
            <el-button
              type="primary"
              @click="getMusicPassword"
              class="w-full"
              :loading="musicPasswordLoading"
            >
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
          <h2
            class="text-lg font-semibold text-gray-900 dark:text-gray-200 mb-4"
          >
            最近活动
          </h2>
...
import { Files, Document, Star, Download } from "@element-plus/icons-vue";
...
const getMusicPassword = async () => {
  ...
  try {
    ...
    if (res.code === 200) {
      ...
      if (enabled) {
        ElMessageBox.alert(`当前音乐验证码为：${password}`, "音乐验证码", {

...
const submit = async () => {
    try {
        ...
        if (res.code === 200) {
            ...
            ElMessage.error(res.message || (isEdit.value ? '更新文章失败' : '发布文章失败'))
        }
    } catch (error) {
        console.error(error)
    ...
    <div class="min-h-[calc(100vh-60px)] bg-gray-50/50 p-4 md:p-6">
        <div class="max-w-[1240px] mx-auto space-y-4 md:space-y-6">
            ...
            <el-skeleton :loading="loading" animated>
                <template #template>
                    <div class="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-100 space-y-4">
            ...
            <el-skeleton :loading="loading" animated>
                <template #template>
                    <div class="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-100 space-y-6">
                                        ...
                                        <el-skeleton v-else-if="categoriesLoading" :count="3" animated>
                                            <template #template>
                                                <div class="flex gap-3">
                                                    <el-skeleton-item variant="text" style="width: 80px" class="!h-8" />
                                                    <el-skeleton-item variant="text" style="width: 80px" class="!h-8" />
                                                    <el-skeleton-item variant="text" style="width: 80px" class="!h-8" />
                                                </div>
                                            </template>

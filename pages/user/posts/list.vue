        ...
        <div class="max-w-[1240px] mx-auto p-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden mb-6">
                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-200 mb-2">我的博客</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm hover:shadow-md transition-all">
                    <div class="flex items-center justify-between mb-4">
                        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-200">新建文章</h2>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
                <template v-if="postsData && postsData.length">
                    <el-table :data="postsData" style="width: 100%" :border="true" class="custom-table">

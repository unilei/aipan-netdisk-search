  ...
  <div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
    <div class="max-w-[1240px] mx-auto px-4 py-20">
      <div class="flex flex-col items-center justify-center space-y-8">
        ...
        <!-- Title -->
        <div class="text-2xl font-bold text-gray-800 dark:text-gray-200 text-center">
          即将离开爱盼-资源随心，娱乐无限
        </div>

        <!-- Link -->
        <div class="text-sm text-gray-600 dark:text-gray-400 break-all px-4 text-center max-w-2xl">
          {{ targetUrl }}
        </div>
